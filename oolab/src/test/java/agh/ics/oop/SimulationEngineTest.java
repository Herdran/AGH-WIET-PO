...
public class SimulationEngineTest {
    ...
    void runTest() {
        ...
        List<Vector2d> expectedPositions = new ArrayList<>(Arrays.asList(new Vector2d(2, 4), new Vector2d(3, 2)));
    ...
    void runTest2() {
        ...
        List<Vector2d> expectedPositions = new ArrayList<>(Arrays.asList(new Vector2d(9, 3), new Vector2d(1, 7)));
    ...
    void runTest3() {
        ...
        List<Vector2d> expectedPositions = new ArrayList<>(Arrays.asList(new Vector2d(2, 7), new Vector2d(8, 10),
                new Vector2d(3, 10), new Vector2d(4, 4), new Vector2d(1, 2)));
